...
let title_names = ["Мальдивы", "Пэм", "Молоко", "Ed Sheeran - Perfect", "котик", "картошечка", "голубой"]
let title_info = [
                "там мило, красиво и хорошо, прям как с ней, ну т.е в смысле она красивая и милая и с ней хорошо...",
                "по секретным материалам от создателей сериала Офис - бОльшая часть образа была списана с Юли...",
